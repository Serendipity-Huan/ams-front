  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">校友管理系统</a>
        <a class="site-navbar__brand-mini" href="javascript:;">校友</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        mode="horizontal">
        <el-menu-item index="1" @click="$router.push({ name: 'alumni-theme' })">
          <template slot="title">
            <el-badge value="new">
...
<script>
  import UpdatePassword from './alumni-main-navbar-update-password'
    ...
    methods: {
      ...
      logoutHandle () {
        this.$confirm(`确定进行[退出]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/basic/alumnusbasic/logout'),
            method: 'post',
            ...
            if (data && data.code === 0) {
              ...
              this.$router.go(0) // 让浏览器自动刷新一次，为什么？需要解决不刷新就无法再次登录的问题
            }
          })
        }).catch(() => {})
      }
