<template>
  <el-dialog
    ...
    <el-form-item label="民族" prop="nationality">
      <el-select v-model="dataForm.nationality" clearable style="width: 100%;">
        <el-option v-for="item in peopleOptions" :key="item.value" :label="item.label" :value="item.value">
        </el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="政治面貌" prop="politicalStatus">
      <el-select v-model="dataForm.politicalStatus" clearable style="width: 100%;">
    ...
    <el-form-item label="籍贯" prop="nativePlace" style="margin-top: 50px;margin-bottom: 50px">
    ...
    <el-form-item label="阶段" prop="degreeStage">
      <el-select v-model.number="dataForm.degreeStage" clearable style="width: 100%;">
    ...
    <el-form-item label="企业性质" prop="enterpriseProperty">
      <el-select v-model="dataForm.enterpriseProperty" clearable  style="width: 100%;">
  ...
  methods: {
    ...
    dataFormSubmit () {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.$confirm('此操作将修改该数据信息, 是否继续?', '提示', {
